...
from Test_Models import VGG3_Test_Q2
...
def main():
    ...
    model = VGG3_Test_Q2(weightBits=Quantization2(quantization.quantize, 4, 1), inputBits=Quantization2(quantization.quantize, 4, 1), quantize_train=q_train, quantize_eval=q_eval).to(device)
